...
def run_pipeline(df, target_column):
    ...
    if problem_type.startswith("Time Series"):
        ...
        return model, problem_type, X_train.columns.tolist()
        ...
        model = train_and_evaluate(problem_type, X_selected, X_test_selected, y_train, y_test)
        return model, problem_type, X_selected.columns.tolist(), label_encoders, scaler
        ...
        return model, problem_type, df_processed.columns.tolist(), label_encoders, scaler
